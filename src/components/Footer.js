        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <TruckIcon className="h-8 w-8 mx-auto mb-4 text-blue-400" />
              <h3 className="text-lg font-semibold mb-2">Free Shipping</h3>
              <p className="text-gray-400">On orders over $50</p>
            </div>
            <div className="text-center">
              <ShieldCheckIcon className="h-8 w-8 mx-auto mb-4 text-green-400" />
              <h3 className="text-lg font-semibold mb-2">Secure Payment</h3>
              <p className="text-gray-400">100% secure transactions</p>
            </div>
            <div className="text-center">
              <ChatBubbleLeftRightIcon className="h-8 w-8 mx-auto mb-4 text-purple-400" />
              <h3 className="text-lg font-semibold mb-2">24/7 Support</h3>
              <p className="text-gray-400">Always here to help</p>
            </div>
            <div className="text-center">
              <CreditCardIcon className="h-8 w-8 mx-auto mb-4 text-yellow-400" />
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:support@yourdollarsonline.com" className="text-gray-400 hover:text-white transition-colors">
                  support@yourdollarsonline.com
                </a>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-gray-400 text-sm">
              © {currentYear} YourDollarsOnline. All rights reserved.
            </div>
